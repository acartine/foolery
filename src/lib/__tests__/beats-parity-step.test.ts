/**
 * Beats parity tests: verify listReady and deriveWorkflowRuntimeState
...
describe("beats parity: deriveWorkflowRuntimeState", () => {
...
describe("beats parity: listReady semantics", () => {
