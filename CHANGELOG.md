...
- 0805b3f: Ship a minor release with richer agent history views, Direct/Beads UX improvements, and settings backfill safeguards for existing installs. Also adopt a Changesets-managed release process.
